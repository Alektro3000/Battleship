...
struct Rotation
{
  ...
  constexpr Rotation(char rot) : Rotation((Value)rot) { }
  constexpr Rotation(Value rot) : value( Value(((rot%4) + 4)%4) ) { }
...
struct Point
{
    ...
    {};
    constexpr Point(T X, T Y) noexcept: x(std::move(X)), y(std::move(Y)) {};
